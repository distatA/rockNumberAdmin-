  ...
  <nav class="site-navbar" :class="'site-navbar--' + navbarLayoutType">
    <div class="site-navbar__header">
      <h1 class="site-navbar__brand" @click="$router.push({ name: 'home' })">
        <a class="site-navbar__brand-lg" href="javascript:;">第一房线上开盘摇号系统</a>
        <a class="site-navbar__brand-mini" href="javascript:;">DYF</a>
      </h1>
    </div>
...
.site-navbar__brand,.userColor{
  color: white  !important;
  /* background-color:#3982e2 !important; */
