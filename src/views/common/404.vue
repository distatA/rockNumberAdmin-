<template>
  <div class="site-wrapper site-page--not-found">
    ...
    <div class="text-box">
      ...
      <div class="text">
        <p class="text__error">找不到这个页面</p>
        <p class="text__error">
          <span>H</span><span>a</span><span>p</span><span>p</span><span>y</span
          ><span>N</span><span>e</span><span>w</span><span>Y</span><span>e</span
          ><span>a</span><span>r</span>
        </p>
        <p class="text__error" style="margin-top: 20px">
          <el-button type="primary" round @click="$router.go(-1)"
            >返回上一页</el-button
          >
        </p>
      </div>
    ...
    <div class="house house--first-floor">
      ...
      <div class="house__bottom">
        ...
        <label class="house-toggle" for="toggle"
          ><span class="house__window"
            ><span class="cat"
              ><span class="cat__face"></span
              ><span class="cat__body"></span></span
            ><span class="present"
              ><span class="present__ribbon"></span></span></span
        ></label>
    ...
    <div class="house house--second-floor">
      ...
      <div class="house__bottom">
        ...
        <label class="house-toggle" for="toggle2"
          ><span class="house__window"
            ><span class="tree"
              ><span class="tree__body"></span
              ><span class="tree__decorations"
                ><span class="tree__decoration"></span
                ><span class="tree__decoration"></span
                ><span class="tree__decoration"></span
                ><span class="tree__decoration"></span
                ><span class="tree__decoration"></span
                ><span class="tree__decoration"></span></span></span></span
        ></label>
        <div class="house__door"></div>
      </div>
      <div class="house__top">
        ...
        <label class="house-toggle" for="toggle3"
...
.house--first-floor .house__bottom .house__window:before,
...
.lease__decoration-part:before,
.lease__decoration-part:after {
  content: "";
  position: absolute;
  top: 0;
  left: 0;
